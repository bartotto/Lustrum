            ...
            <div class="col-lg-7 col-md-7 col-sm-7">
                <div class="card card-block">
                    ...
                    <div class="card-body">                      
                        ...
                        <img src="img/Destination/Kaukasus_2.jpg" style="width:100%">
                        <h3>{{ trans('info.caucasus2') }}</h3>
                        <img src="img/Destination/Kaukasus_3.jpg" style="width:100%">
                        <h3>{{ trans('info.caucasus3') }}</h3>
                        <img src="img/Destination/Kaukasus_4.jpg" style="width:100%">
                        <h3>{{ trans('info.caucasus4') }}</h3>
                        <img src="img/Destination/Klimaat.jpg" style="width:100%">
                    </div>
                </div>
            </div>
            <div class="col-lg-5 col-md-5 col-sm-5">
                <div class="card card-block">
                    <img class="card-img-top" src="img/Other/Caucasus-map.png" alt="Kaukasus map" height="auto" width="48">
                    <div class="card-header">
