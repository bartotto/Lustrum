        ...
        <div class="col-lg-7 col-md-4 col-sm-6">
            <div class="card card-block">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Zoek je maten op in de tabel hieronder en registreer het getal in de eerste kolom bij <a href="/users/{{ Auth::user()->id }}">je profiel</a>. Wees er snel bij!</p>
                    <table class="table">
                        <thead>
                            <tr>
                                <th scope="col"></th>
