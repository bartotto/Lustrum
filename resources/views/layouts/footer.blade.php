<footer class="bart-footer">
    <div class="container">
        <div>
            <img src="/img/Logos/Kenya.jpg" alt="Kenya" height="auto" width="80">
            ...
            <img src="/img/Logos/Carpathians.jpg" alt="Carpathians" height="auto" width="80">
            <img src="/img/Logos/Dalarna.jpg" alt="Dalarna" height="auto" width="80">
            <img src="/img/Logos/Georgia.jpg" alt="Georgia" height="auto" width="80">
        </div>
        <p align="center">{{ trans('info.footer') }}</p>
        <p align="center">
            <a href="#">{{ trans('info.footer_up') }}</a>
        </p>
    </div>
</footer>